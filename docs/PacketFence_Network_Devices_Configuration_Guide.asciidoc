...
image::docs/images/allied-telesis-gs950/vlan-config.png[scaledwidth="100%",alt="VLAN configuration"]
...
image::docs/images/allied-telesis-gs950/radius-server.png[scaledwidth="100%",alt="RADIUS configuration"]

Next, configure an SNMP community (SNMP->Community Table)

image::docs/images/allied-telesis-gs950/snmp-config.png[scaledwidth="100%",alt="SNMP configuration"]
...
image::docs/images/allied-telesis-gs950/port-control-MAB.png[scaledwidth="100%",alt="MAB config"]
...
image::docs/images/allied-telesis-gs950/port-control-802.1x.png[scaledwidth="100%",alt="802.1x configuration"]
...
image::docs/images/cisco-downloadable-acl-reg.png[scaledwidth="100%",alt="Registration ACL"]
...
image::docs/images/cisco-downloadable-acl-cross-network.png[scaledwidth="100%",alt="Cross network deny ACL"]

You could also only prevent your guest users from using shared directories

image::docs/images/cisco-downloadable-acl-deny-shares.png[scaledwidth="100%",alt="Deny shares ACL"]

Or also you could restrict your users to use only your DNS server where 192.168.5.2 is your DNS server

image::docs/images/cisco-downloadable-acl-force-dns.png[scaledwidth="100%",alt="Force DNS ACL"]
...
image::docs/images/aruba-registration-acl.png[scaledwidth="100%",alt="Registration ACL"]
...
image::docs/images/aruba-acl-default-guest.png[scaledwidth="100%",alt="Cross network deny ACL"]

You could also only prevent your guest users from using shared directories

image::docs/images/aruba-acl-guest.png[scaledwidth="100%",alt="Deny shares ACL"]

You could also restrict your users to use only your DNS server where 192.168.5.2 is your DNS server

image::docs/images/aruba-acl-default-dns.png[scaledwidth="100%",alt="Force DNS ACL"]
...
image::docs/images/aruba-create-guest-vlan.png[scaledwidth="100%",alt="Guest VLAN"]

Next, you will need to configure a RADIUS server.

image::docs/images/aruba-radius-server.png[scaledwidth="100%",alt="RADIUS server"]
...
image::docs/images/aruba-config-coa.png[scaledwidth="100%",alt="RADIUS CoA server"]
...
image::docs/images/aruba-l3-auth1.png[scaledwidth="100%",alt="Layer 3 profile"]
image::docs/images/aruba-l3-auth2.png[scaledwidth="100%",alt="Layer 3 profile 2"]
...
image::docs/images/aruba-config-aaa-profile1.png[scaledwidth="30%",alt="AAA profile 1"]
image::docs/images/aruba-config-aaa-profile2.png[scaledwidth="100%",alt="AAA profile 2"]
image::docs/images/aruba-config-aaa-profile3.png[scaledwidth="100%",alt="AAA profile 3"]
image::docs/images/aruba-config-aaa-profile4.png[scaledwidth="100%",alt="AAA profile 4"]
image::docs/images/aruba-config-aaa-profile5.png[scaledwidth="100%",alt="AAA profile 5"]
image::docs/images/aruba-config-aaa-profile6.png[scaledwidth="100%",alt="AAA profile 6"]
...
image::docs/images/aruba-config-policy1.png[scaledwidth="100%",alt="Policy 1"]
image::docs/images/aruba-config-policy2.png[scaledwidth="100%",alt="Policy 2"]
image::docs/images/aruba-config-policy3.png[scaledwidth="100%",alt="Policy 3"]
image::docs/images/aruba-config-policy4.png[scaledwidth="100%",alt="Policy 4"]
image::docs/images/aruba-config-policy5.png[scaledwidth="100%",alt="Policy 5"]
...
image::docs/images/aruba-config-user-role.png[scaledwidth="100%",alt="User Role"]
image::docs/images/aruba-interface-redirection.png[scaledwidth="100%",alt="Interface de redirection"]
...
image::docs/images/aruba-ap-config1.png[scaledwidth="30%",alt="Config AP 1"]
image::docs/images/aruba-ap-config2.png[scaledwidth="100%",alt="Config AP 2"]
image::docs/images/aruba-ap-config3.png[scaledwidth="100%",alt="Config AP 3"]
image::docs/images/aruba-ap-config4.png[scaledwidth="100%",alt="Config AP 4"]
image::docs/images/aruba-ap-config5.png[scaledwidth="100%",alt="Config AP 5"]
image::docs/images/aruba-ap-config6.png[scaledwidth="100%",alt="Config AP 6"]
image::docs/images/aruba-ap-config7.png[scaledwidth="100%",alt="Config AP 7"]
image::docs/images/aruba-ap-config8.png[scaledwidth="100%",alt="Config AP 8"]
image::docs/images/aruba-ap-config9.png[scaledwidth="100%",alt="Config AP 9"]
image::docs/images/aruba-ap-config10.png[scaledwidth="100%",alt="Config AP 10"]
image::docs/images/aruba-ap-config11.png[scaledwidth="100%",alt="Config AP 11"]

image::docs/images/aruba-secondary-controller.png[scaledwidth="100%",alt="Secondary controller configuration"]
...
image::docs/images/aruba-wlc1.png[scaledwidth="80%",alt="Add Aruba wireless controller"]
image::docs/images/aruba-wlc-roles.png[scaledwidth="80%",alt="Aruba wireless controller roles configuration"]
...
image::docs/images/SSID_1.png[scaledwidth="100%",alt="SSID step 1"]

image::docs/images/SSID_2.png[scaledwidth="100%",alt="SSID step 2"]

image::docs/images/SSID_3.png[scaledwidth="100%",alt="SSID step 3"]

image::docs/images/SSID_4.png[scaledwidth="100%",alt="SSID step 4"]

image::docs/images/SSID_5.png[scaledwidth="100%",alt="SSID step 5"]

image::docs/images/SSID_6.png[scaledwidth="100%",alt="SSID step 6"]

NOTE: On more recent controllers, the value 'Radius NAC' in the 'NAC State' setting will be called 'ISE NAC'.

image::docs/images/SSID_7.png[scaledwidth="100%",alt="SSID step 7"]
...
image::docs/images/ACL.png[scaledwidth="100%",alt="ACL"]

* Then the last step is to configure the WLC in PacketFence.
Role by Web Auth URL

image::docs/images/WLC_PACKETFENCE.png[scaledwidth="100%",alt="ACL"]

Role definition

image::docs/images/WLC_PACKETFENCE2.png[scaledwidth="100%",alt="ACL"]
...
image::docs/images/ipsk1.png[scaledwidth="100%",alt="SSID step 1"]

image::docs/images/ipsk2.png[scaledwidth="100%",alt="SSID step 2"]

image::docs/images/ipsk_radius.png[scaledwidth="100%",alt="SSID step 3"]
...
image::docs/images/dpsk_provisioner.png[scaledwidth="100%",alt="Provisioner IPKS"]
...
image::docs/images/wlc-device-sensor.png[scaledwidth="100%",alt="Device Sensor"]
...
image::docs/images/Meraki-V2-1.png[scaledwidth="100%",alt="Security and RADIUS configuration"]

image::docs/images/Meraki-V2-2.png[scaledwidth="100%",alt="Network configuration"]
...
image::docs/images/Meraki-config-policy.png[scaledwidth="100%",alt="Group policies"]

Your configuration for the tab "Roles" in PacketFence will look like the following:

image::docs/images/Meraki-config-pf-role.png[scaledwidth="100%",alt="PacketFence role configuration"]

image::docs/images/Meraki-config-pf-url.png[scaledwidth="100%",alt="PacketFence URL configuration"]
...
image::docs/images/Meraki-vlan-pf.png[scaledwidth="100%",alt="PacketFence role configuration"]
...
image::docs/images/Meraki-switch-policies.png[scaledwidth="100%",alt="Access policies"]
...
image::docs/images/Meraki-switch-port.png[scaledwidth="100%",alt="Switch Ports"]
...
PacketFence supports only SSIDs configured with 802.1X.

Configure the 802.1X Secure SSID:
+++++++++++++++++++++++++++++++++
* Login to the https://dashboard.mojonetworks.com
* Create the 802.1X SSID:
* Go to *Services -> Mojo Wireless Manager*
...
* Finally *Radio 1 - 2x2 b/g/n Configuration -> Add SSID Profile -> Select your SSID profile previously created -> Ok*
...
image::docs/images/ruckus_hotspot_service.png[scaledwidth="100%",alt="Hotspot Service"]
...
image::docs/images/ruckus_create_ssid.png[scaledwidth="100%",alt="Hotspot Service"]
...
image::docs/images/ruckus-smartzone-webauth-hotspot.png[scaledwidth="100%",alt="Ruckus SmartZone Hotspot"]
...
image::docs/images/ruckus-smartzone-webauth-ssid.png[scaledwidth="100%",alt="Ruckus SmartZone SSID"]
...
image::docs/images/ubiquiti-unifi-guest-policy.png[scaledwidth="100%",alt="Unifi web-auth policy"]
...
image::docs/images/ubiquiti-unifi-guest-ssid.png[scaledwidth="100%",alt="Unifi web-auth SSID"]
