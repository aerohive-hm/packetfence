...
func Connect_to_rdc() int {

   /*
	node_info := []Onboarding{
		{"hello",
			"47B4-FB5D-7817-2EDF-0FFE-D9F0-944A-9B72",
			"9999",
			"Hello HM!",
		},
		{"hello",
			"47B4-FB5D-7817-2EDF-0FFE-D9F0-944A-9B73",
			"99992222",
			"Hello HM2222!",
		},
	}
...
func fetch_vhmid(s string) int {
	...
	*/
	...
	for {
		...
		//vhmid := fmt.Sprintf("%d", vhmres.Data.OwnerId)
...
func Connect_to_gdc_rdc() int {
	result := connet_to_gdc()
	if result != 0 {
		return result
	}
