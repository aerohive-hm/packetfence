package pfappserver::Form::Config::Source::Instagram;

=head1 NAME

pfappserver::Form::Config::Source::Instagram - Web form for a Instagram user source

=head1 DESCRIPTION

Form definition to create or update a Instagram user source.
...
has_field 'domains' =>
  (
   ...
   required => 1,
   default => pf::Authentication::Source::InstagramSource->meta->get_attribute('domains')->default,
   element_attr => {'placeholder' => pf::Authentication::Source::InstagramSource->meta->get_attribute('domains')->default},
   element_class => ['input-xlarge'],
   tags => { after_element => \&help,
