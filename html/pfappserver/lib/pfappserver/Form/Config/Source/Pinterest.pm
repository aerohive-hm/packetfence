package pfappserver::Form::Config::Source::Pinterest;

=head1 NAME

pfappserver::Form::Config::Source::Pinterest - Web form for a Pinterest user source

=head1 DESCRIPTION

Form definition to create or update a Pinterest user source.
...
use pf::Authentication::Source::PinterestSource;
...
has_field 'access_token_path' =>
  (
   ...
   required => 1,
   default => pf::Authentication::Source::PinterestSource->meta->get_attribute('access_token_path')->default,
  );
has_field 'access_token_param' =>
  (
   ...
   required => 1,
   default => pf::Authentication::Source::PinterestSource->meta->get_attribute('access_token_param')->default,
  );
has_field 'scope' =>
  (
   type => 'Text',
   label => 'Scope',
   required => 1,
   default => pf::Authentication::Source::PinterestSource->meta->get_attribute('scope')->default,
...
has_field 'protected_resource_url' =>
  (
   ...
   required => 1,
   default => pf::Authentication::Source::PinterestSource->meta->get_attribute('protected_resource_url')->default,
   element_class => ['input-xlarge'],
  );
has_field 'redirect_url' =>
  (
   ...
   label => 'Portal URL',
   required => 1,
   default => pf::Authentication::Source::PinterestSource->meta->get_attribute('redirect_url')->default,
...
has_field 'domains' =>
  (
   ...
   required => 1,
   default => pf::Authentication::Source::PinterestSource->meta->get_attribute('domains')->default,
