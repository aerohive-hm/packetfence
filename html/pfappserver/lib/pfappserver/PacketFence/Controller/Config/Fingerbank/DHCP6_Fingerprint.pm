package pfappserver::PacketFence::Controller::Config::Fingerbank::DHCP6_Fingerprint;

=head1 NAME

pfappserver::PacketFence::Controller::Config::Fingerbank::DHCP6_Fingerprint

=head1 DESCRIPTION

Controller for managing the fingerbank DHCP6_Fingerprint data
