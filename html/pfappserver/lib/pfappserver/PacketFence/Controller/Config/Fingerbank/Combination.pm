package pfappserver::PacketFence::Controller::Config::Fingerbank::Combination;

=head1 NAME

pfappserver::PacketFence::Controller::Config::Fingerbank::Combination

=head1 DESCRIPTION

Controller for managing the fingerbank Combination data
...
__PACKAGE__->config(
    action => {
        ...
        scope  => { Chained => '/', PathPart => 'config/fingerbank/combination', CaptureArgs => 1 },
    },
    action_args => {
